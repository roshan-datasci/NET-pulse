...
def interpret_clusters():
    ...
    # Higher download speed and stronger RSSI indicate
    # generally better connectivity in our current dataset.
    #
    # We use download speed as the primary ordering signal
    # because it directly represents observed performance.
